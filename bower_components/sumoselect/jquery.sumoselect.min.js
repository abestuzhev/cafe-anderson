...
!function (e) {
    ...
    e.fn.SumoSelect = function (t) {
        var l = e.extend({
            ...
            csvDispCount: 3,
            captionFormat: "Вы выбрали: {0}",
            captionFormatAllSelected: "Вы выбрали все: {0}!",
            floatWidth: 400,
            ...
            !this.sumo && e(this).is("select") && (this.sumo = {
                ...
                nav: function (e) {
                    var t, l = this, i = l.ul.find("li.opt:not(.disabled, .hidden)"), s = l.ul.find("li.opt.sel:not(.hidden)"), n = i.index(s);
